namespace SimpleHttpServer
{
    ...
    public class HttpProcessor
    {
        ...
        private HttpResponse RouteRequest()
        {
            ...
            {
                return new HttpResponse(ResponseStatusCode.Page_Not_Found);
            }
            ...
            try
            {
                response = route.Callable(Request);
            }
            catch (Exception e)
            {
                Console.WriteLine(e.Message);
                return new HttpResponse(ResponseStatusCode.Internal_Server_Error);
            }
            return response;
        }
